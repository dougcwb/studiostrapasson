...
var themes = [
		[ "#FFFFFF", "#233A66", "#72478F", "#674287", "#233A66" ],
		];
var theme;
...
function createInstructions() {
	...
	text.innerHTML = '<span style="color:' + theme[0] + ';font-size:25px;">Bem-vindo!</span><br>Clique na Logo para entrar no site';
	...
	b2body.position.Set( Math.random() * stage[2], Math.random() * 500);
